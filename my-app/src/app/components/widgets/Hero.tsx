            ...
            <Wrapper>
                <div className="flex mt-8">
                    ...
                    <div className="flex-1 mt-12">
                        ...
                        <h1 className="text-6xl my-4 font-bold">Certified Web 3.0 and Metaverse Developer</h1>
                        <p className="text-xl my-6 text-slate-500">A One and Quarter Years Panaverse DAO Earn as you Learn Program Getting Ready for the Next Generation of the Internet.
                            <br /><br />
